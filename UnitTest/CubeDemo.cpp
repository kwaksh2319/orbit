...
void CubeDemo::Render()
{
	...
	ImGui::SliderFloat("cPositionx", &position.x,-10000,10000);
	ImGui::SliderFloat("cPositiony", &position.y, -10000, 10000);
	ImGui::SliderFloat("cPositionz", &position.z, -10000, 10000);
